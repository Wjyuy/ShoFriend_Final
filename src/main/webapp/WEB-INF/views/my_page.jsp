					...
					<div class="row">
						...
						<!-- <div class="col-md-9"> -->
							<div class="top-area">
								...
								<br>
								<div class="button cart-button">
									<button class="btn" style="width: 100%;" onclick="location.href='product_insert'">상품 추가</button>
								</div>
								<br>
								<div class="wish-button">
									<button class="btn" style="width: 100%;" onclick="location.href='logout'">로그아웃</button>
					...
					<div class="row">
						...
						<!-- <div class="col-md-9"> -->
							<div class="top-area">
								...
								<br>
								<div class="button cart-button">
									<button class="btn" style="width: 100%;" onclick="location.href='main'">메인으로</button>
								</div>
							</div>
						</div>
					</div>
